...
<div>
    ...
    <div id="m-beranda">
        <div class="m-header">
            ...
            <div class="m-summary fade-up">
                ...
                <div class="m-pills">
                    <div class="m-pill c" wire:click="getBukuTabungan" @click="$store.sheet.show('detail-saldo')">
    ...
    <div x-show="$store.sheet.is('detail-trx')" x-transition:enter="transition ease-out duration-300"
        ...
        <div style="flex:1;overflow-y:auto;padding:0 10px 10px;-webkit-overflow-scrolling:touch">
            <div wire:loading.flex wire:target="getTrxByAuthUser" class="justify-content-center align-items-center"
                style="position:absolute;inset:0;background:rgba(255,255,255,0.6);z-index:10;border-radius:inherit">
                <div class="spinner-border text-success"></div>
            </div>
            <div class="row g-2">
